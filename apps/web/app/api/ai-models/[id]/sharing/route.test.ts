...
const mockedPrisma = mockPrisma<{
  ...
  userAiModelAccess: {
    findMany: typeof prisma.userAiModelAccess.findMany;
    findFirst: typeof prisma.userAiModelAccess.findFirst;
    create: typeof prisma.userAiModelAccess.create;
    update: typeof prisma.userAiModelAccess.update;
  };
  user: {
...
describe('GET /api/ai-models/[id]/sharing', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('returns 404 when model not found', async () => {
    ...
    const request = new NextRequest('http://localhost/api/ai-models/model-1/sharing');
    const response = await GET(request, { params: Promise.resolve({ id: 'model-1' }) });
  ...
  it('returns list of shares for model owner', async () => {
    ...
    mockedPrisma.userAiModelAccess.findMany.mockResolvedValueOnce([
      {
        id: 'access-1',
        userId: 'user-2',
        aiModelId: 'model-1',
...
describe('POST /api/ai-models/[id]/sharing', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('creates new share for specific user', async () => {
    ...
    mockedPrisma.userAiModelAccess.create.mockResolvedValueOnce({
      id: 'access-1',
      userId: 'user-2',
      aiModelId: 'model-1',
      permission: 'READ',
  ...
  it('updates existing share when share already exists', async () => {
    ...
    mockedPrisma.userAiModelAccess.update.mockResolvedValueOnce({
      id: 'access-1',
      userId: 'user-2',
      aiModelId: 'model-1',
      permission: 'WRITE',
