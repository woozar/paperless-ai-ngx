...
const mockedPrisma = mockPrisma<{
  ...
  userAiProviderAccess: {
    findMany: typeof prisma.userAiProviderAccess.findMany;
    findFirst: typeof prisma.userAiProviderAccess.findFirst;
    create: typeof prisma.userAiProviderAccess.create;
    update: typeof prisma.userAiProviderAccess.update;
  };
  user: {
...
describe('GET /api/ai-providers/[id]/sharing', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('returns 404 when provider not found', async () => {
    ...
    const response = await GET(request, { params: Promise.resolve({ id: 'provider-1' }) });
  ...
  it('returns list of shares for provider owner', async () => {
    ...
    mockedPrisma.userAiProviderAccess.findMany.mockResolvedValueOnce([
      {
        id: 'access-1',
        userId: 'user-2',
...
describe('POST /api/ai-providers/[id]/sharing', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('creates new share for specific user', async () => {
    ...
    mockedPrisma.userAiProviderAccess.create.mockResolvedValueOnce({
      id: 'access-1',
      userId: 'user-2',
      aiProviderId: 'provider-1',
      permission: 'READ',
  ...
  it('creates new share for all users (userId = null)', async () => {
    const mockDate = new Date('2024-01-15T10:00:00Z');
    mockAuth();
    mockedPrisma.aiProvider.findFirst.mockResolvedValueOnce({
      id: 'provider-1',
  ...
  it('updates existing all-users share', async () => {
    ...
    mockedPrisma.userAiProviderAccess.update.mockResolvedValueOnce({
      id: 'access-1',
      userId: null,
      aiProviderId: 'provider-1',
      permission: 'WRITE',
  ...
  it('updates existing share when already shared', async () => {
    const mockDate = new Date('2024-01-15T10:00:00Z');
    mockAuth();
    mockedPrisma.aiProvider.findFirst.mockResolvedValueOnce({
      id: 'provider-1',
