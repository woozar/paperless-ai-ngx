    ...
    return NextResponse.json({
      items: instances.map((instance) => {
        ...
        return {
          ...
          scanCronExpression: instance.scanCronExpression,
          defaultAiBotId: instance.defaultAiBotId,
          lastScanAt: instance.lastScanAt?.toISOString() ?? null,
          nextScanAt: instance.nextScanAt?.toISOString() ?? null,
          autoApplyTitle: instance.autoApplyTitle,
          autoApplyCorrespondent: instance.autoApplyCorrespondent,
          autoApplyDocumentType: instance.autoApplyDocumentType,
          autoApplyTags: instance.autoApplyTags,
          autoApplyDate: instance.autoApplyDate,
